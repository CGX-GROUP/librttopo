...
int rect_tree_contains_point(RTCTX *ctx, const RECT_NODE *tree, const RTPOINT2D *pt, int *on_boundary);
int rect_tree_intersects_tree(RTCTX *ctx, const RECT_NODE *tree1, const RECT_NODE *tree2);
